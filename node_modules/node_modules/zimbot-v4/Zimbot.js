...
//▮YOUTUBE CHANNELL: https://youtube.com/c/sacoleOFC
//▮
//╰▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
//
//┏━━━━━━━━━━━━━━━━━━━━━━━━━
...
const { exec, spawn, execSync } = require('child_process').exec;
...
//message type
/* let sacole = fs.readFileSync('./Zimbot/sacole.jpg') 
*/
...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "sacole OFC", thumbnail: fs.readFileSync('./sacole.jpg'),sourceUrl: ("https://wa.me/27634090203")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "sacole OFC", thumbnail: fs.readFileSync('./sacole.jpg'),sourceUrl: "https://wa.me/27634090203="}}})
}
...
previewType: "PHOTO",
thumbnail: fs.readFileSync('./sacole.jpg'),
...
showAdAttribution: true,
  title: "ZIM BOT V4", 
  jpegThumbnail: fs.readFileSync('./sacole.jpg')
}
}
 }
...
const sacole = require('sacole-memes')
...
if (isCmd && !m.isGroup)
console.log(color('[ RECIEVED ]'), color(time, 'red'), color(`${command} [${args.length}]`), sacole.hr(), 'FROM', color(pushname))

if (isCmd && m.isGroup)
console.log(color('[ RECIEVED ]'), color(time, 'red'), color(`${command} [${args.length}]`), sacole.hr(), 'FROM', color(pushname), 'in', color(groupName))
...
if (global.sacolereadall) { if (m.message) { ZimBotInc.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
}
if (global.sacolerecord) { if (m.chat) { ZimBotInc.sendPresenceUpdate('recording', m.chat) }
}

if (global.sacoletyping) { if (m.chat) { ZimBotInc.sendPresenceUpdate('composing', m.chat) }
}
...
let beesacole = [f1,f2,f3,f4,f5,f6]
        let sacoleee = pickRandom(beesacole)
...
hydratedFooterText: `RPG GAME BY ZIM-BOT`,
hydratedButtons:  [{        
    "urlButton": {
      "displayText": "SUBSCRIBE",
      "url": "https://www.youtube.com/c/sacoleOFC"
    }
}, {
quickReplyButton: {
...
var mhata = `${command}`
sehcalaz = ZimBotInc.user.id.split('@')[0]
var duzvi = encodeURI(mhata)
const bhabhi = {
  method: 'GET',
  url: `http://api.brainshop.ai/get?bid=167831&key=BFghpAKanUPXcLWQ&uid=ZimBotinc.user.id&msg=${command}`
}
await axios.get('http://api.brainshop.ai/get?bid=167831&key=BFghpAKanUPXcLWQ&uid=' + sehcalaz + '&msg=' + duzvi ).then(function (response) {
var dhuru = ''	
dhuru = response.data.cnt
reply(dhuru)
...
/*const dchatbot = {
  ...
  params: {bid: '167831', key: 'BFghpAKanUPXcLWQ', uid: 'ZimBotinc.user.id', msg: `${command}`},
  headers: {
...
axios.request(dchatbot).then(function (response) {
...
switch(command) {
  case 'quest':
    ...
    ZimBotInc.sendList(m.chat, `Hi Chomie *${pushname}*`, `Please Select Below`, "CLICK", "RPG GAME BY ZIM-BOT ", sectionnya, { quoted: m})
    break
    case 'slime':
    case 'killslime':
...
var button = [
        ...
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `RPG GAME BY ZIM-BOT`, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n *┊ Place*  ${ad}\n ┊ *MONEY :* $${money}\n ┊ *EXP :* ${adven}Xp`
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `RPG GAME BY ZIM-BOT`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
 ...
 break
 case 'sc': case 'script': case 'donate': {
  ...
  *ZIM-BOT-V4*\n\n*YOUTUBE:* https://youtu.be/ww4z2m3uORU\n*GITHUB:* https://github.com/zim-bot/zimbot-v4/fork\n\n*DONATE:* https://paypal/zimbotinc`
  ...
  body: "sacole OFC", 
  showAdAttribution: true,
  thumbnail: fs.readFileSync("Zimbot/sacole.jpg"),
  mediaType:1,
...
{ buttonId: `${command} off`, buttonText: { displayText: 'OFF' }, type: 1 }
  ...
  await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊ _CHATBOT_ ▊▊*`, ZimBotInc.user.name, m)
}
  }   
break 
case 'welcome': {
  ...
  { buttonId: `${command} off`, buttonText: { displayText: 'OFF' }, type: 1 }
    ...
    await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊ _WELCOME_ ▊▊*`, ZimBotInc.user.name, m)
  }
    }   
  break 
//-----GROUP---\\
...
case 'antilink': {
 ...
 if (!isAdmins) throw mess.admin
 if (args[0] === "on") {
 if (db.chats[m.chat].antilink) return m.reply(`*Already on umm okay*`)
 db.chats[m.chat].antilink = true
 reply(`*Antilink active*`)
 } else if (args[0] === "off") {
 if (!db.chats[m.chat].antilink) return m.reply(`*Already off okay*`)
...
await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANTILINK MODE▊▊▊*`, ZimBotInc.user.name, m)
}
}
break
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antiytchannel) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antiytchannel = true
reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antiytchannel) return m.reply(`*Already off okay*`)
...
break
 case 'antilinkinstagram': case 'asacoleantiig': case 'antiinsta': {
if (!m.isGroup) throw mess.group
if (!isBotAdmins) throw mess.botAdmin
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antiinstagram) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antiinstagram= true
reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antiinstagram) return m.reply(`*Already off okay*`)
...
case 'antilinkfacebook': case 'antifb': {
 ...
 if (!isAdmins) throw mess.admin
 if (args[0] === "on") {
 if (db.chats[m.chat].antifb) return m.reply(`*Already on umm okay*`)
 db.chats[m.chat].antifb = true
 reply(`*Antilink active*`)
 } else if (args[0] === "off") {
 if (!db.chats[m.chat].antifb) return m.reply(`*Already off okay*`)
...
break
case 'antitelegram': case 'asacoleantitele': {    
 if (!m.isGroup) throw mess.group
 if (!isBotAdmins) throw mess.botAdmin
 if (!isAdmins) throw mess.admin
 if (args[0] === "on") {
 if (db.chats[m.chat].antitelegram) return m.reply(`*Already on umm okay*`)
 db.chats[m.chat].antitelegram = true
 reply(`*Antilink active*`)
 } else if (args[0] === "off") {
 if (!db.chats[m.chat].antitelegram) return m.reply(`*Already off okay*`)
...
case 'antivn': case 'antiaudio': case 'antivoicenote': case 'antivoice': {
 ...
 await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANT VN MODE▊▊▊*`, ZimBotInc.user.name, m)
  }
   }
 break
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antisticker) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antisticker = true
reply(`*Antisticker active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antisticker) return m.reply(`*Already off okay*`)
...
await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANTISTICKER MODE▊▊▊*`, ZimBotInc.user.name, m)
}
}
break
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antiphoto) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antiphoto = true
reply(`*Antiphoto active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antiphoto) return m.reply(`*Already off okay*`)
...
await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANTIPHOTO MODE▊▊▊*`, ZimBotInc.user.name, m)
}
}
break
case 'antivideo': case 'antivid': {
  ...
  if (!isAdmins) throw mess.admin
  if (args[0] === "on") {
  if (db.chats[m.chat].antivideo) return m.reply(`*Already on umm okay*`)
  db.chats[m.chat].antivideo = true
  reply(`*Antivideo active*`)
  } else if (args[0] === "off") {
  if (!db.chats[m.chat].antivideo) return m.reply(`*Already off okay*`)
 ...
 await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANTIVIDEO MODE▊▊▊*`, ZimBotInc.user.name, m)
  }
   }
 break
...
if (args[0] === "on") {
if (global.db.chats[m.chat].antionce) return m.reply(`*Already activated*`)
global.db.chats[m.chat].antionce = true
reply(`${command} *Successfully Activated*`)
} else if (args[0] === "off") {
  if (!global.db.chats[m.chat].antionce) return m.reply(`*Already deactivated*`)
...
await ZimBotInc.sendButtonText(m.chat, sacole, `*▊▊▊ANTILINK VIEW▊▊▊*`, `${global.botname}`, m)
}
break
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antitiktok) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antitiktok = true
reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antitiktok) return m.reply(`*Already off okay*`)
...
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
 if (db.chats[m.chat].antilinkall) return m.reply(`*Already on umm okay*`)
 db.chats[m.chat].antilinkall = true
 reply(`*Antilink active*`)
 } else if (args[0] === "off") {
 if (!db.chats[m.chat].antilinkall) return m.reply(`*Already off okay*`)
...
break
case 'asacoleantitwt': case 'antitwitter': case 'antilinktwit': {
if (!m.isGroup) throw mess.group
if (!isBotAdmins) throw mess.botAdmin
if (!isAdmins) throw mess.admin
if (args[0] === "on") {
if (db.chats[m.chat].antitwitter) return m.reply(`*Already on umm okay*`)
db.chats[m.chat].antitwitter = true
reply(`*Antilink active*`)
} else if (args[0] === "off") {
if (!db.chats[m.chat].antitwitter) return m.reply(`*Already off okay*`)
...
{ buttonId: `${command} off`, buttonText: { displayText: 'OFF' }, type: 1 }
 ...
 await ZimBotInc.sendButtonText(m.chat, sacolei, `*▊▊▊ANTILINK MODE▊▊▊*`, ZimBotInc.user.name, m)
}
 }
break
...
break
 ...
 fatihgans = fs.readFileSync('./Zimbot/sacole.jpg')
...
case 'update':
  ...
  if (commits.total === 0) {
    ...
    await ZimBotInc.sendMessage(m.chat ,mss,"Feel free to update!",buttons);
...
case 'upd':
    ...
    if (commits.total === 0) {
      ...
      await ZimBotInc.sendMessage("_Build started ⏫_")
      try {
...
*◉Tɪᴛʟᴇ :* ${sacole2.videos[0].title}
*◉Sɪᴢᴇ :* ${data.medias[7].formattedSize}
*◉Dᴇꜱᴄʀɪᴘᴛɪᴏɴ :* ${sacole2.videos[0].description}`
message = await prepareWAMessageMedia({ image : { url: sacole2.videos[0].thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
quickReplyButton: {
displayText: `VIDEO`,
id: `${prefix}ytmp4 ${sacole2.videos[0].url}`
}
}, {
quickReplyButton: {
displayText: `SONG`,
id: `${prefix}ytmp3 ${sacole2.videos[0].url}`
}
}, {
quickReplyButton: {
displayText: `YTSEARCH`,
id: `${prefix}ytsearch ${sacole2.videos[0].title}`
}
}]
}
}
...
case 'bc2': case 'bcloc': {
if (!isCreator) throw mess.owner
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} sacole|hi5`
let anu = await store.chats.all().map(v => v.id)
...
case 'once': case 'toonce': { //by sacole
if (!quoted) throw 'Reply Image'
if (/image/.test(mime)) {
...
dhuripi(sacole, function (error, response, body) {
	if (error) throw new Error(error);
reply(body)
	console.log(body);
});
...
const dripbabe = {
  method: 'GET',
  url: 'https://google-news.p.rapidapi.com/v1/search',//By sacole 
...
const luckysure = {
  method: 'GET',
  url: 'https://free-news.p.rapidapi.com/v1/search',//By sacole
  qs: {q: `${text}`, lang: 'en'},
  headers: {
...
case 'igsearch':
  const sacoleig = {
    method: 'GET',
    url: 'https://instagram-data1.p.rapidapi.com/user/search',//By sacole
    qs: {keyword: `${text}`},
    headers: {
  ...
  magwettta(sacoleig, function (error, response, body) {
    if (error) throw new Error(error);
    reply(body);
    console.log(body);
  });
  ...
  const drpsapk = {
      method: 'GET',
      url: 'https://apk-downloader1.p.rapidapi.com/',
      qs: {id: 'com.freevpn.lite'},
      headers: {
        lang: 'en',
        country: 'us',
    ...
    let dankie = require('request')
    dankie(drpsapk, function (error, response, body) {
      if (error) throw new Error(error);
      reply(body);
      console.log(body);
    });
...
case 'ipdomain':
    ...
    case 'ip':
      ...
      bhudhi(sacoleba, function (error, response, body) {
        if (error) throw new Error(error);
        reply(body);
        console.log(body);
      });
...
case 'checknumber':
  ...
  dhidhi(sacoleka, function (error, response, body) {
    if (error) throw new Error(error);
    reply(body);
    console.log(body);
  });
...
{ buttonId: 'keluar', buttonText: { displayText: 'STOP🌟' }, type: 1 }
 ...
 case 'attp': {
  reply(mess.wait)
  if (!text) throw `*Example : ${prefix + command} sacole hi*`
...
timestampe = speed();
totalChat = await store.chats.all()
...
`
    ...
    let buttons = [
    {buttonId: `halo2`, buttonText: {displayText: 'SOURCECODE'}, type: 3}
    ]
    let buttonMessage = {
...
`,
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://www.youtube.com/c/sacoleOFC` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/zim-bot/zimbot-v3` } },
    {					
    quickReplyButton: {
    displayText: 'SPEED',
    id: 'ping'
    ...
    fileName: `ZIM BOT-V4`,
    fileLength: 99999999999999,
    templateButtons: buttonsDefault,footer: `${botname}`, quoted: mudratunha}) 
    }
  }
break
case 'mainmenu': {
